 ...
 */
public class AnioCocheraHistorialFragment extends Fragment{
    private RecyclerView mAndioCocheraHistorial;
    ...
    {
        View root = inflater.inflate(R.layout.fragment_historial_cochera_anio,container,false);
        mAndioCocheraHistorial = (RecyclerView)root.findViewById(R.id.id_fragmento_anio);
    ...
    private void configuracionHistorialDeVisitas()
    {
        ...
        mAndioCocheraHistorial.setLayoutManager(new LinearLayoutManager(getActivity()));
        mAndioCocheraHistorial.setAdapter(adapter);
    }
